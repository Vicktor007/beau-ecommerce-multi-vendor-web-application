...
import com.vic.ecommerce.service.impl.CustomeUserServiceImplementation;
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String subject = "Beau Email Verification Code";
        String text = "Welcome to Beau, verify your account using this link ";
        String frontend_url = frontEndUrl + "/verify-seller/";
